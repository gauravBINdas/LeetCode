class Solution {
    public int maxArea(int[] height) {
        ...
        // Now onwards, width will always decrease by 1 unit whether I increment left or decrement right.So ,the only factor remains to determine max area is height.
